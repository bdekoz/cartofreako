...
loop, evaluation or training suitability, provider selection or use, value, or
payment. State changes are appended to the ledger rather than rewriting the
creation record.
