...
[geometric context](myriahedral-context.md#the-169-canvas) for that
distinction.
...
The wrapper in [the complete example](web-example.md#c-source) adds:
...
[`docs/web-example.md`](web-example.md). They are kept in the documentation
