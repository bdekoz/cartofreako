...
| 8 Anthropocene | **Complete first observation atlas** | [`generate-anthropocene.cc`](../../../src.generate/generate-anthropocene.cc), a year/profile contract, source-separated metrics, preparation and validation, all projections, and [`anthropocene-implementation-notes.md`](../passes/anthropocene/implementation.md). Its station and regional-source coverage is deliberately sparse and North-America-heavy. |
