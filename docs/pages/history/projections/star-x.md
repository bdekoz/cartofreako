...
> geometry is documented in [Star-X geometric context](../../projections/star-x/context.md) and
> [implementation notes](../../projections/star-x/implementation.md). In particular, the
