...
in the [implementation notes](implementation.md#reference-half-octant-construction).
...
[implementation notes](implementation.md#projected-path-seam-handling)
...
[forward/reverse API](../../runtime/projection-api.md) and the
[implementation plan and issues](implementation.md#reverse-implementation-plan-and-completion-record).
