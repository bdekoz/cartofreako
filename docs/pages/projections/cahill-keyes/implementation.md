...
the [projection-neutral forward/reverse contract](../../runtime/projection-api.md)
...
the [generation guide](../../getting-started/generation.md#cahill-keyes-enlargement-slices).
...
[Natural Earth geometry processing](../../getting-started/generation.md#geometry-processing).
...
[bibliography](bibliography.md) records the source and design
history.
