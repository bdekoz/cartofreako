...
- [`converge-generation.md`](../history/generation-request-ledger.md) is the raw request and
  stage ledger; and
...
| --- | --- | --- | --- |
| 4.1 | `generate-astro` / space and astronomy | **Implemented** | Visualization-grade feasibility, source roles, profile authority, calculation methods, products, and limits are summarized below and detailed in the [astronomy implementation notes](../passes/astronomy.md) |
| 4.1a | `generate-cloud-atmosphere` | **Implemented** | Confirmed P-Tree physical-cloud contract, regional/daytime coverage, process-start solar calculation, source-timed JAXA atmosphere layers, H3 preparation, products, and limits are detailed in the [Cloud-atmosphere implementation notes](../passes/cloud-atmosphere.md) |
| 4.2 | `generate-orbiting` / Orbital Technosphere | **Implemented** | Naming, NASA/CelesTrak feasibility, OMM/SGP4, profile authority, products, and limits are summarized below and detailed in the [Orbital Technosphere implementation notes](../passes/orbital-technosphere.md) |
| 4.4 | `generate-network-swarm` | **Implemented** | Confirmed variable-input contract, fixed cumulative snapshot, H3/Izzi clustering, projection-safe components, independent downloader layers, products, and limits are detailed in the [network-swarm implementation notes](../passes/network-swarm.md) |
| 4.5 | `generate-bathymetry-roulette` | **Implemented; Stage 13 revised** | Cycloid-minimum filled forms, depth-only `d/r`, 24-region Voronoi grouping, 30% opacity, restored blue ramp, clipping, accepted moiré, products, and limits are detailed in the [Bathymetry Roulette implementation notes](../passes/bathymetry/roulette.md) |
| 4.6 | `generate-bathymetry-hamonshu` | **Implemented** | Separate source-indexed Izzi Hamonshū wave-field experiment using the same depth/Voronoi/opacity/blue architecture is detailed in the [Bathymetry Hamonshū implementation notes](../passes/bathymetry/hamonshu.md) |
...
[`astro-implementation-notes.md`](../passes/astronomy.md).
...
[`cloud-atmosphere-implementation-notes.md`](../passes/cloud-atmosphere.md).
...
[`orbital-technosphere-implementation-notes.md`](../passes/orbital-technosphere.md).
...
[`network-swarm-implementation-notes.md`](../passes/network-swarm.md).
...
[`bathymetry-roulette-implementation-notes.md`](../passes/bathymetry/roulette.md).
...
[Bathymetry Hamonshū implementation notes](../passes/bathymetry/hamonshu.md).
...
thresholds are recorded in the [`Resources Stage 12 enrichment plan`](../passes/resources/enrichment-plan.md)
and [`implementation notes`](../passes/resources/implementation.md).
...
are recorded in
[`network-infrastructure-implementation-notes.md`](../passes/network-infrastructure.md).
...
[resources implementation notes](../passes/resources/implementation.md).
