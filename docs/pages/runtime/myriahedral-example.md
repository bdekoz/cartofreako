...
[Web workflow](myriahedral-workflow.md) ·
...
[all-projection quick start](webassembly-quick-start.md). A separate
...
[web workflow](myriahedral-workflow.md#seam-aware-graticule-generation) and the
[general generation notes](../getting-started/generation.md).
